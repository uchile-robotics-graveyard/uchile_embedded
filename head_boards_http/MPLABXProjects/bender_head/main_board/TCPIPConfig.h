 ...
 */
#define MY_DEFAULT_HOST_NAME            "bender-head"
 ...
 */
    ...
    #define TCP_ETH_RAM_SIZE                    (3096ul)
    ...
    #define END_OF_TCP_SOCKET_TYPES
        ...
        } TCPSocketInitializer[] = 
        {
            ...
            {TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 500, 1000},
            {TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 500, 1000},
...
// -- HTTP2 Server options -----------------------------------------------
    ...
    #define HTTP_DEFAULT_FILE       "control.html"
    #define HTTPS_DEFAULT_FILE      "control.html"
